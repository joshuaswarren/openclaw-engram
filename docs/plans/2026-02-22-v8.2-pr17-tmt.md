...
## Test plan
- [ ] All tests pass
- [ ] `temporalMemoryTreeEnabled: false` → no files written, no recall section added
- [ ] `temporalMemoryTreeEnabled: true` → nodes built after consolidation, summary injected
EOF
)"
```
