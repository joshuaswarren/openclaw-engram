...
const NEAR_PARAPHRASE: ContradictionBenchCase[] = [
  {
    ...
    textB: "The TypeScript dependency for Remnic is version 5.9.",
  ...
  },
  {
    ...
    textB: "By default, memories are stored under the .remnic/memories folder in the user's home directory.",
    expectedVerdict: "duplicates",
    categoryA: "fact",
    categoryB: "fact",
  },
  {
    ...
    textB: "Extraction, recall, and buffering are coordinated by the orchestrator through three lifecycle phases.",
    expectedVerdict: "duplicates",
    categoryA: "fact",
    categoryB: "fact",
  },
  {
    ...
    textB: "API keys and other secrets must not be committed to the codebase.",
    expectedVerdict: "duplicates",
    categoryA: "principle",
    categoryB: "principle",
  },
