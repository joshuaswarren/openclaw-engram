...
export function registerLcmTools(api: ToolApi, engine: LcmEngine): void {
  ...
  api.registerTool(
    {
      name: "engram_context_search",
      label: "Search Conversation History",
      description:
        "Search all conversation history (including compacted regions) by keyword. " +
        "Returns matching message snippets from the lossless context archive.",
  ...
  api.registerTool(
    {
      name: "engram_context_describe",
      label: "Describe Conversation Range",
      description:
        "Get a compressed summary of a conversation turn range. " +
        "Uses the hierarchical summary DAG to provide the best available summary.",
      parameters: Type.Object({
  ...
  api.registerTool(
    {
      name: "engram_context_expand",
      label: "Expand Conversation Range",
      description:
        "Retrieve full conversation messages for a turn range (lossless). " +
        "Use this to recover the exact content of messages that may have been compacted.",
      parameters: Type.Object({
        session_id: Type.String({
